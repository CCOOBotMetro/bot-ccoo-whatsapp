...
def generar_resposta(pregunta):
    try:
        ...
        print("❌ Error generant la resposta:", str(e), flush=True)
        return f"Ho sento, ha fallat la generació de la resposta. ({str(e)})"
...
def webhook():
    ...
    try:
        ...
        print(f"Error llegint el missatge: {e}", flush=True)
        return "OK", 200
