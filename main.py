   ...
   try:
    ...
    if session["state"] == "inici":
        ...
        if text_lower in ["1", "permisos", "permís", "permiso"]:
            ...
            missatge = "Per altres consultes pots escriure a: ccoometro@tmb.cat" if lang == "ca" else "Para otras consultas puedes escribir a: ccoometro@tmb.cat"
            enviar_missatge(sender, f"{missatge}\n\n{text_nova_consulta(lang)}")
